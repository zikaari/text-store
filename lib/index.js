...
class TextStore {
    ...
    zeroBasedPosToIndex(zeroBasedPos) {
    ...
    convertPosToZeroBased(pos) {
        return {
            col: pos.col - 1,
            line: pos.line - 1,
        };
    }
    checkTextPosition(pos) {
    ...
    clampTextPosition(pos) {
        const clampedLine = clamp_1.default(pos.line, 1, this.lines.length);
        return {
            col: clamp_1.default(pos.col, 1, this.lines[clampedLine].length),
            line: clampedLine,
        };
    }
    /**
     ...
     * @param end
     */
    findHighestCachedIndexToPos(start, end) {
     ...
     * @param end
     */
    findHighestCachedLineToIndex(start, end) {
        let diff = end - start;
